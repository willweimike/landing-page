...
const I18N = {
  zh: {
    ...
    feat: {
      ...
      f5t: '程序技能庫（15 內建）',
      f5d: '內建 15 種 <code>ProcedureSkill</code>，依情境動態載入，涵蓋調試、資料庫、Email 等場景。',
      f6t: '後執行學習迴路',
      ...
      f9t: '可擴展工具集目錄',
      f9d: '內建 7 大工具集（預設：assistant/file/terminal/search/skills/memory/browser），並支援 database、mcp 擴展。',
      f10t: '完整事件溯源稽核',
      f10d: '透過 Event Sourcing 完整記錄生命週期，可隨時回放。',
      f11t: 'TUI 終端互動介面',
      f11d: '<code>autonomy tui</code> 提供即時狀態總覽與互動。',
      f12t: '多 Provider 支援',
      f12d: '支援 Ollama 及 8 個 OpenAI 相容的 API Provider，含 DeepSeek、xAI、Kimi、NVIDIA 等。',
      f13t: 'MCP 外部工具整合',
    ...
    arch: {
      ...
      techtitle: 'TOOLSET_CATALOG (40+ Tools) — 工具集 & AI Providers',
      providertitle: '支援 AI Provider（9 個）',
      memorySub: 'memory.remember / recall / list / forget（預設啟用）',
    },
    toolsets: {
      tag: '內建技能',
      h2: '15 個 Bundled Procedure Skills',
    ...
    author: {
      ...
      bio2: '致力於打造在真實工程環境中可靠運行的 AI 系統，透過嚴謹架構實現完全的可稽核性。',
      linkedin: 'LinkedIn',
      github: 'GitHub',
    },
    qs: {
    ...
    footer: {
      ...
      copy: '© 2025–2026 Bill Liu · Autonomy Framework · AgentLoop · ProcedureSkillLibrary · CuratorDaemon',
    },
  },
  ...
  en: {
    ...
    feat: {
      ...
      f5t: 'Procedure Skill Library (15 built-in)',
      f5d: '15 built-in <code>ProcedureSkills</code> dynamically loaded per context, covering debugging, database, email and more.',
      ...
      f9d: '7 default toolsets (assistant/file/terminal/search/skills/memory/browser), with opt-in database and mcp.',
      ...
      f12d: 'Supports Ollama and 8 OpenAI-compatible providers including DeepSeek, xAI, Kimi, NVIDIA.',
      f13t: 'MCP External Tool Integration',
    ...
    arch: {
      ...
      techtitle: 'TOOLSET_CATALOG (40+ Tools) — Toolsets & AI Providers',
      providertitle: 'Supported AI Providers (9)',
      memorySub: 'memory.remember / recall / list / forget (default enabled)',
    },
    toolsets: {
      tag: 'Built-in Skills',
      h2: '15 Bundled Procedure Skills',
    ...
    sec: {
      ...
      h2: 'Enterprise-Grade Security Boundaries',
